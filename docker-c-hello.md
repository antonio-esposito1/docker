...
## Facciamo una modifica al nostro codice

Facciamo una modifica al nostro codice e pubblichiamola
...
int main () {
  ...
  for (i = 0; i < 10; ++i)
    printf("%d %d %d %d\n", i, power(2,i), power(-3,i), power2(4,i));
}
...
[+] Building 1.3s (9/9) FINISHED                                                                                                                                                                    docker:default
 => [internal] load build definition from Dockerfile                                                                                                                                                          0.0s
 => => transferring dockerfile: 200B                                                                                                                                                                          0.0s
 => [internal] load metadata for docker.io/library/gcc:latest                                                                                                                                                 0.9s
 => [internal] load .dockerignore                                                                                                                                                                             0.0s
 => => transferring context: 2B                                                                                                                                                                               0.0s
 => [internal] load build context                                                                                                                                                                             0.0s
 ...
 => => exporting layers                                                                                                                                                                                       0.0s
 => => writing image sha256:a9b0d0debd2b8558d0588dde25f965b911231acdd9c2fd7af8727df4853f5945                                                                                                                  0.0s
 => => naming to docker.io/antonioesposito1/docker-c-hello:latest                                                                                                                                             0.0s
...
```
```
antonio@labnet5:~/docker/docker-c-hello$ docker run -it antonioesposito1/docker-c-hello:latest 
0 1 1 1
1 2 -3 4
2 4 9 16
3 8 -27 64
...
antonio@labnet5:~/docker/docker-c-hello$ 
```
loggiamoci di nuovo al docker hub, nota che questa volta mi chiede di confermare via browser che il codice è corratto
```
antonio@labnet5:~/docker/docker-c-hello$ docker login 
...
Your one-time device confirmation code is: SMZF-RFJK
Press ENTER to open your browser or submit your device code here: https://login.docker.com/activate

Waiting for authentication in the browser…


WARNING! Your credentials are stored unencrypted in '/home/antonio/.docker/config.json'.
...
antonio@labnet5:~/docker/docker-c-hello$ docker image ls
REPOSITORY                        TAG       IMAGE ID       CREATED         SIZE
antonioesposito1/docker-c-hello   latest    a9b0d0debd2b   4 minutes ago   1.54GB
antonioesposito1/docker-c-hello   <none>    4c8820d85657   2 hours ago     1.54GB
example/docker-node-hello         latest    52f273faacd7   5 days ago      1.02GB
alpine                            latest    9234e8fb04c4   2 months ago    8.31MB
antonio@labnet5:~/docker/docker-c-hello$ docker image push antonioesposito1/docker-c-hello:latest 
The push refers to repository [docker.io/antonioesposito1/docker-c-hello]
...
e2de4c327490: Pushed 
938f3fec0aa1: Layer already exists 
0f13bd1c281f: Layer already exists 
cd9afcfdbf90: Layer already exists 
a6d5b81d8677: Layer already exists 
25bde18331a6: Layer already exists 
698d92e1248d: Layer already exists 
1260506aec83: Layer already exists 
a5ec5ec9d16c: Layer already exists 
latest: digest: sha256:89d059eda974fcf27049ff5ade36b661d361e5602c95fe2c91b88a48acef2b0d size: 2629
antonio@labnet5:~/docker/docker-c-hello$ 
```
```
antonio@labnet5:~/docker/docker-c-hello$ docker logout 
Removing login credentials for https://index.docker.io/v1/
antonio@labnet5:~/docker/docker-c-hello$ 
```
